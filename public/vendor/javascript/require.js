...
(function(ba) {
  function G(b) {return "[object Function]" === K.call(b)}
  ...
  function ga(b) {
    ...
    function d(a) {
      z && v(document.getElementsByTagName("script"), function(j) {
        if (j.getAttribute("data-requiremodule") === a &&
            j.getAttribute("data-requirecontext") === h.contextName) {
          return j.parentNode.removeChild(j), !0
        }
      })
    }
    ...
    function p(a) {
      var j = n(k.paths, a);
      if (j && H(j) && 1 < j.length) {
        return j.shift(), h.require.undef(a), h.makeRequire(null, {skipMap: !0})([a]), !0
      }
    }
    ...
    function i(a,
      ...
      a = a[1];
      e && (e = c(e, i, f), d = n(q, e));
      a && (e ? m = d && d.normalize ? d.normalize(a, function(a) {return c(a, i, f)}) : -1 === a.indexOf("!") ? c(a, i,
        f) : a : (m = c(a, i, f), a = g(m), e = a[0], m = a[1], b = !0, l = h.nameToUrl(m)));
    ...
    function s(a,
               j, b) {
      var f = a.id, c = n(m, f);
      if (t(q, f) && (!c || c.defineEmitComplete)) {
        "defined" === j && b(q[f]);
      } else if (c = r(a), c.error && "error" ===
                                      j) {
        b(c.error);
      } else {
        c.on(j,
    ...
    function J() {
      ...
      for (x(); C.length;) {
        a = C.shift();
        if (null === a[0]) {
          return w(B("mismatch", "Mismatched anonymous define() module: " + a[a.length - 1]));
        }
        E(a)
      }
      h.defQueueMap = {}
    ...
    L = {
      require: function(a) {return a.require ? a.require : a.require = h.makeRequire(a.map)},
      exports: function(a) {
        a.usingExports = !0;
        if (a.map.isDefine) {
          return a.exports ? q[a.map.id] = a.exports : a.exports = q[a.map.id] = {}
        }
      },
      module: function(a) {
        return a.module ? a.module : a.module = {
          id: a.map.id,
          uri: a.map.url,
          config: function() {return n(k.config, a.map.id) || {}},
    ...
    Z.prototype = {
      init: function(a, b, c, f) {
        ...
        if (!this.inited) {
          ...
          if (c) {
            ...
            this.events.error && (c = u(this, function(a) {this.emit("error", a)}));
          }
      ...
      fetch: function() {
        if (!this.fetched) {
          ...
          var a = this.map;
          if (this.shim) {
            h.makeRequire(this.map, {enableBuildCallback: !0})(this.shim.deps || [],
            ...
            if (this.error) {
              ...
              if (!this.defining) {
                ...
                if (1 > this.depCount && !this.defined) {
                  ...
                  this.exports = f;
                  if (this.map.isDefine && !this.ignore && (q[c] = f, e.onResourceLoad)) {
                    e.onResourceLoad(h, this.map,
                      this.depMaps);
                  }
                  y(c);
                  this.defined = !0
      ...
      callPlugin: function() {
        ...
        s(d, "defined", u(this, function(f) {
          var l, d;
          d = n(aa, this.map.id);
          var g = this.map.name, P = this.map.parentMap ? this.map.parentMap.name : null, p = h.makeRequire(a.parentMap,
            {enableBuildCallback: !0});
          if (this.map.unnormalized) {
            if (f.normalize && (g = f.normalize(g, function(a) {return c(a, P, !0)}) || ""), f = i(a.prefix + "!" + g,
                this.map.parentMap), s(f, "defined", u(this, function(a) {
                this.init([], function() {return a},
                  null, {
                    enabled: !0,
                    ignore: !0
                  })
              ...
              if (this.events.error) {
                d.on("error", u(this, function(a) {this.emit("error", a)}));
              }
              d.enable()
            }
          } else {
            d ? (this.map.url = h.nameToUrl(d), this.load()) : (l = u(this,
              function(a) {this.init([], function() {return a}, null, {enabled: !0})}), l.error = u(this, function(a) {
              this.inited = !0;
              this.error = a;
              a.requireModules = [b];
              A(m, function(a) {0 === a.map.id.indexOf(b + "_unnormalized") && y(a.map.id)});
              w(a)
      ...
      enable: function() {
        ...
        v(this.depMaps, u(this, function(a, b) {
          ...
          if ("string" === typeof a) {
            ...
            this.depCount += 1;
            s(a, "defined", u(this, function(a) {this.undefed || (this.defineDep(b, a), this.check())}));
            this.errback ? s(a, "error", u(this, this.errback)) : this.events.error && s(a, "error",
              u(this, function(a) {this.emit("error", a)}))
          }
          c = a.id;
          f = m[c];
      ...
      emit: function(a, b) {
        v(this.events[a], function(a) {a(b)});
    ...
    h = {
      ...
      configure: function(a) {
        ...
        A(a, function(a, b) {c[b] ? (k[b] || (k[b] = {}), U(k[b], a, !0, !0)) : k[b] = a});
        a.bundles && A(a.bundles, function(a, b) {
          v(a,
            function(a) {a !== b && (aa[a] = b)})
        });
        ...
        A(m, function(a, b) {!a.inited && !a.map.unnormalized && (a.map = i(b, null, !0))});
      ...
      makeRequire: function(a, j) {
        function g(c, d, p) {
          ...
          if ("string" === typeof c) {
            if (G(d)) {
              return w(B("requireargs", "Invalid require call"), p);
            }
            if (a && t(L, c)) {
              return L[c](m[a.id]);
            }
            if (e.get) {
              return e.get(h, c, a, g);
            }
            k = i(c, a, !1, !0);
            k = k.id;
            return !t(q, k) ? w(B("notloaded", 'Module name "' + k + '" has not been loaded yet for context: ' + b +
                                               (a ? "" : ". Use require([])"))) : q[k]
          }
          J();
          h.nextTick(function() {
        ...
        U(g, {
          ...
          defined: function(b) {return t(q, i(b, a, !1, !0).id)},
        ...
        a || (g.undef = function(b) {
          ...
          delete S[c.url];
          delete $[b];
          T(C, function(a, c) {a[0] === b && C.splice(c, 1)});
          delete h.defQueueMap[b];
          e && (e.events.defined && ($[b] = e.events), y(b))
        });
        return g
      },
      enable: function(a) {n(m, a.id) && r(a).enable()},
      completeLoad: function(a) {
        ...
        if (!b && !t(q, a) && c && !c.inited) {
          if (k.enforceDefine && (!e || !da(e))) {
            return p(a) ? void 0 : w(B("nodefine", "No define call for " + a, null,
              [a]));
          }
          E([
            a,
      ...
      onScriptLoad: function(a) {
        if ("load" === a.type ||
            ia.test((a.currentTarget || a.srcElement).readyState)) {
          N = null, a = I(a), h.completeLoad(a.id)
        }
      },
      onScriptError: function(a) {
        var b = I(a);
        if (!p(b.id)) {
          return w(B("scripterror", "Script error for: " + b.id, a, [b.id]))
        }
      }
    };
  ...
  x = Object.prototype;
  var K =
        x.toString, fa = x.hasOwnProperty, z = !!("undefined" !== typeof window && "undefined" !== typeof navigator &&
                                                  window.document), ea = !z &&
                                                                         "undefined" !== typeof importScripts, ia = z &&
                                                                                                                    "PLAYSTATION 3" ===
                                                                                                                    navigator.platform ? /^complete$/ : /^(complete|loaded)$/, Y = "undefined" !==
                                                                                                                                                                                   typeof opera &&
                                                                                                                                                                                   "[object Opera]" ===
                                                                                                                                                                                   opera.toString(), F = {}, s = {}, R = [], M = !1;
  if ("undefined" === typeof define) {
    ...
    e.config = function(b) {return e(b)};
    e.nextTick = "undefined" !== typeof setTimeout ? function(b) {setTimeout(b, 4)} : function(b) {b()};
    require || (require = e);
    e.version = "2.1.20";
    e.jsExtRegExp = /^\/|:|\?|\.js$/;
    e.isBrowser = z;
    ...
    if (z &&
        (y = x.head = document.getElementsByTagName("head")[0], D = document.getElementsByTagName("base")[0])) {
    ...
    e.load = function(b, c, d) {
      ...
      if (z) {
        g = e.createNode(p,
          c, d);
        if (p.onNodeCreated) {
          p.onNodeCreated(g, p, c, d);
        }
        g.setAttribute("data-requirecontext", b.contextName);
        g.setAttribute("data-requiremodule", c);
        g.attachEvent && !(g.attachEvent.toString && 0 > g.attachEvent.toString().indexOf("[native code")) &&
        !Y ? (M = !0, g.attachEvent("onreadystatechange", b.onScriptLoad)) : (g.addEventListener("load", b.onScriptLoad,
          !1), g.addEventListener("error", b.onScriptError, !1));
        g.src = d;
        J = g;
      ...
      if (ea) {
        try {importScripts(d), b.completeLoad(c)} catch (i) {
    ...
    z && !s.skipDataMain && T(document.getElementsByTagName("script"), function(b) {
      ...
      if (I = b.getAttribute("data-main")) {
        return r = I, s.baseUrl ||
                      (E = r.split("/"), r = E.pop(), O = E.length ? E.join("/") +
                                                                     "/" : "./", s.baseUrl = O), r = r.replace(Q,
          ""), e.jsExtRegExp.test(r) && (r = I), s.deps = s.deps ? s.deps.concat(r) : [r], !0
      }
    });
    define = function(b, c, d) {
      ...
      !c && G(d) && (c = [], d.length && (d.toString().replace(ja, "").replace(ka,
        function(b, d) {c.push(d)}), c = (1 === d.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
      if (M) {
        if (!(e = J)) {
          N && "interactive" === N.readyState || T(document.getElementsByTagName("script"),
            function(b) {
    ...
    define.amd = {jQuery: !0};
    e.exec = function(b) {return eval(b)};
    e(s)
  }
})(this);
